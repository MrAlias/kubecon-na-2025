...
<div class="warning-box">Warning or caution with pink accent</div>

<div class="success-box">Success message with turquoise accent</div>
```
...
```css
/* Primary Colors */
--cncf-blue: #0086ff --cncf-black: #000000 /* Secondary Colors */
  --cncf-turquoise: #93eaff --cncf-pink: #d62293 --cncf-stone: #e5e5e5
